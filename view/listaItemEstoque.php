...
<head>
    ...
    <style>
        ...
        .col-fornecedor { width: 160px; }
        .col-valor { width: 110px; }
        .col-minimo { width: 110px; }
        .col-acoes { width: 280px; text-align: center; }
...
<body>
    <header>
        ...
        <nav>
            ...
            <a href="/Gestione-Manager/php/cadastrarFuncionario.php">CADASTRAR FUNCIONÁRIOS</a>
            ...
            <table class="tabela-moderna">
                <thead>
                    <tr>
                        ...
                        <th class="col-minimo">Estoque Atual</th>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr id="item-<?= $i['id'] ?>">
                            ...
                            <td>
                                <div class="btn-grupo">
                                    <button class="btn-acao btn-fluxo" onclick="window.location.href='formularioFluxoItens.php?id=<?= $i['id'] ?>'">Registro de Entrada/Saída</button>
                                    
                                    <button class="btn-acao btn-alterar" onclick="window.location.href='formularioItemEstoque.php?id=<?= $i['id'] ?>'">Alterar</button>
