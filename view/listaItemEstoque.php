...
<head>
    ...
    <style>
        ...
        /* Ajuste das larguras das colunas sem o estoque atual */
        .col-id { width: 60px; }
        .col-nome { width: 300px; }
        .col-categoria { width: 150px; }
        .col-fornecedor { width: 220px; }
        ...
        <div class="tabela-card">
            <table class="tabela-moderna">
                ...
                <tbody>
                    <?php if (empty($itens)): ?>
                        <tr>
                            <td colspan="6" style="text-align: center; padding: 30px; color: #7f8c8d;">Nenhum insumo cadastrado até o momento.</td>
                        </tr>
                    <?php else: ?>
